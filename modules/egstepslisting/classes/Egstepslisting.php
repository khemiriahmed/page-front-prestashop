...
class EgSteps extends objectModel
{
    /** 
     * @var string image
     */
    ...
    public static function getMaxPosition()
    {
        return  Db::getInstance()->getValue(
            'SELECT MAX(position) FROM `'._DB_PREFIX_.'stepslisting`'
        );
    }
    ...
    public static function getListContent($id_lang, $id_shop)
    {
        return Db::getInstance()->executeS(
            'SELECT * FROM '._DB_PREFIX_.'stepslisting egr
            LEFT JOIN '._DB_PREFIX_.'stepslisting_lang egrl on egr.id_stepslisting = egrl.id_stepslisting
