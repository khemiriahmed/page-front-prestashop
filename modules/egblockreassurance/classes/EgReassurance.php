...
class EgReassurance extends objectModel
{
    /** 
     * @var string image
     */
    ...
    public static function getMaxPosition()
    {
        return  Db::getInstance()->getValue(
            'SELECT MAX(position) FROM `'._DB_PREFIX_.'egreassurance`'
        );
    }
    ...
    public static function getListContent($id_lang, $id_shop)
    {
        return Db::getInstance()->executeS(
            'SELECT * FROM '._DB_PREFIX_.'egreassurance egr
            LEFT JOIN '._DB_PREFIX_.'egreassurance_lang egrl on egr.id_egreassurance = egrl.id_egreassurance
            AND egrl.id_lang = '.$id_lang.' WHERE egr.id_shop = '.(int) $id_shop
        );
    }
