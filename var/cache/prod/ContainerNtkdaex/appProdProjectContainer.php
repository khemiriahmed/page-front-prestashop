...
class appProdProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('e72nMMa+DA', 0, ($this->targetDirs[0].'/pools'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_c44f02fdcdfff81b3b74be1fe16c7e118d089da7d0376975c618e9522c6576ed');
    ...
    protected function getPrestashop_Addons_ClientApiService()
    {
        ...
        $instance->setSslVerification('D:\\webbax/var/cache/prod\\cacert.pem');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(${($_ = isset($this->services['debug.file_link_formatter']) ? $this->services['debug.file_link_formatter'] : ($this->services['debug.file_link_formatter'] = new \Symfony\Component\HttpKernel\Debug\FileLinkFormatter(NULL))) && false ?: '_'}, 'D:\\webbax\\app', 'UTF-8'));
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'router.resource' => 'D:\\webbax\\app/config/routing.yml',
            ...
            'ps_cache_dir' => 'D:\\webbax/var/cache/prod\\',
            ...
            'prestashop.addons.api_client.verify_ssl' => 'D:\\webbax/var/cache/prod\\cacert.pem',
